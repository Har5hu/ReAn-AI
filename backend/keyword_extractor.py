...
def extract_job_keywords(job_description_text):
    ...
    KNOWN_TECH_PATTERNS = [
        ...
        (r'\bhtml\b', "HTML"), (r'\bcss\b', "CSS"), (r'\bjavascript\b', "JavaScript"), 
        (r'\btypescript\b', "TypeScript"), (r'\bjava\b', "Java"), (r'\bc\+\+\b', "C++"),
        (r'\bc#\b', "C#"), (r'\bangular\b', "Angular"), (r'\bvue\.?js\b', "Vue.js"),
        (r'\bmongo(?:db)?\b', "MongoDB"), (r'\bexpress\.?js\b', "Express.js"), (r'\bgit\b', "Git"),
        (r'\bmysql\b', "MySQL"), (r'\bpostgresql\b', "PostgreSQL"), (r'\bsql server\b', "SQL Server"),
        (r'\blinux\b', "Linux"), (r'\bdatabase management\b', "Database Management"), (r'\bdata modeling\b', "Data Modeling"),
